"""
Credit:
This repository uses code and methodologies from the following sources:

1. Source Repository: 
   Downloaded from: https://github.com/bnsreenu/python_for_microscopists

2. Original Code and License:
   - MIT License
...
Purpose:
The original code enables smooth predictions on an image by using tiled prediction patches 
and performs blending and smoother segmentation results.
"""
...
# Import this function to predict using blend
