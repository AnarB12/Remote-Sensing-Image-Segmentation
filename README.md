...
This repository contains the code used for my master's thesis on satellite image segmentation. The primary focus of this project is on segmenting remote sensing images using the U-Net architecture. It includes data preprocessing, model training, and evaluation.
